...
public class MTLServer extends DCMSPOA {
	...
	protected MTLServer() throws IOException 
	{
		super();
...
//	
			...
			String specialization, String location) 
	{
		try{	
			...
			synchronized(this) {
				if(MTLServer.database.containsKey(key)){
					records=MTLServer.database.get(key);
					records.add(recobj);
	...
	{
		String s="MTL "+MTLServer.database.size()+" ";
