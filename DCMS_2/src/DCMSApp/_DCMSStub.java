...
public class _DCMSStub extends org.omg.CORBA.portable.ObjectImpl implements DCMSApp.DCMS
{
  ...
  public boolean createTRecord (String firstName, String lastName, String address, String phone, String specialization, String location)
  {
            ...
            try {
                ...
                return createTRecord (firstName, lastName, address, phone, specialization, location        );
            } finally {
                _releaseReply ($in);
            }
  } // createTRecord

  public boolean createSRecord (String firstName, String lastName, String courseRegistered, String status, int statusDate)
  {
            org.omg.CORBA.portable.InputStream $in = null;
            try {
                ...
                return createSRecord (firstName, lastName, courseRegistered, status, statusDate        );
            } finally {
                _releaseReply ($in);
            }
  } // createSRecord
  ...
  public String[] getRecordCounts ()
  {
            ...
            try {
                ...
                $in = _invoke ($out);
                String $result[] = DCMSApp.stringarrayHelper.read ($in);
                return $result;
            } catch (org.omg.CORBA.portable.ApplicationException $ex) {
                $in = $ex.getInputStream ();
                String _id = $ex.getId ();
  ...
  public boolean transferRecord (String managerId, String recordId, String remoteCenterLocation)
  {
            org.omg.CORBA.portable.InputStream $in = null;
            try {
                ...
                $out.write_string (recordId);
                $out.write_string (remoteCenterLocation);
                $in = _invoke ($out);
                boolean $result = $in.read_boolean ();
                return $result;
            } catch (org.omg.CORBA.portable.ApplicationException $ex) {
                ...
                return transferRecord (managerId, recordId, remoteCenterLocation        );
            } finally {
                _releaseReply ($in);
            }
  } // transferRecord
